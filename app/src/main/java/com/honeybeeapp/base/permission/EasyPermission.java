...
import com.honeybeeapp.widgets.IOSAlertDialog;
...
public class EasyPermission {
    ...
    public static void requestPermissions(final Object object, String rationale, @StringRes int positiveButton,
        ...
        final List<String> deniedPermissions = Tools.findDeniedPermissions(Tools.getActivity(object), permissions);
        ...
        for (String perm : deniedPermissions) {
            shouldShowRationale = shouldShowRationale || Tools.shouldShowRequestPermissionRationale(object, perm);
        }

        if (Tools.isEmpty(deniedPermissions)) {
            mCallBack.onEasyPermissionGranted(requestCode, permissions);
        } else {
            ...
            if (shouldShowRationale) {
                Activity activity = Tools.getActivity(object);
                if (null == activity) {
                    return;
                }


                new IOSAlertDialog(activity).builder().setMsg(rationale)
                        .setPositiveButton(activity.getString(R.string.ios_confirm), new View.OnClickListener() {
                            @Override public void onClick(View v) {
                                executePermissionsRequest(object, deniedPermissionArray, requestCode);
                            }
                        })
                        .setNegativeButton(activity.getString(R.string.ios_cancel), new View.OnClickListener() {
                            @Override public void onClick(View v) {
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object, String rationale,
                                                              ...
                                                              @Nullable View.OnClickListener negativeButtonOnClickListener, String... deniedPerms) {
        boolean shouldShowRationale;
        for (String perm : deniedPerms) {
            shouldShowRationale = Tools.shouldShowRequestPermissionRationale(object, perm);

            if (!shouldShowRationale) {
                final Activity activity = Tools.getActivity(object);
                if (null == activity) {
                    return true;
                }
                ...
                new IOSAlertDialog(activity).builder().setMsg(rationale)
                        ...
                        .setNegativeButton(activity.getString(R.string.ios_cancel), negativeButtonOnClickListener)
                        .show();
